...
class Http:
        ...
        self.api = {
            ...
            "rock": {
                "random": lambda: self.get(
                    "https://rockapi.apiworks.tech/random", _json=True
                ),
            ...
            "some-random-api": {
                "bottoken": lambda: self.get(
                    "https://some-random-api.ml/bottoken", _json=True
                ),
                "animal": lambda animal: self.get(
                    f"https://some-random-api.ml/animal/{animal}"
                ),
                "binary-encode": lambda string: self.get(
                    f"https://some-random-api.ml/binary?encode={string}"
                ),
                "binary-decode": lambda binary: self.get(
    ...
    async def update_data(self):
        self.cache["piston"]["runtimes"] = await self.get(
            "https://emkc.org/api/v2/piston/runtimes", _json=True
        )
